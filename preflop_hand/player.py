...
class Player(Bot):
    ...
    def get_action(self, game_state, round_state, active):
        ...
        if street == 0:
            ...
            #if my_cards[0][0] < my_cards[1][0]:
            #    range_beginning = ranks[(int(my_cards[1][0]] + ranks[my_cards[0][0]]
            #else:
            #    range_beginning = ranks[my_cards[0][0]] + ranks[my_cards[1][0]]

            my_preflop_range = my_cards[0][0] + my_cards[1][0] + range_ending
            my_preflop_range_alt = my_cards[1][0] + my_cards[0][0] + range_ending

            preflop_confidence = 0
            if my_preflop_range in range_hash:
                preflop_confidence = range_hash[my_preflop_range]
            elif my_preflop_range_alt in range_hash:
                preflop_confidence = range_hash[my_preflop_range_alt]
